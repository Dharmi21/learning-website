<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="newwebsite.user.index" %>
...
<%--                <asp:Label ID="Label1" class="navbar-brand" runat="server" Text="Hiya_Academy" ForeColor="#007bff"></asp:Label>--%>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto w-100 justify-content-end">
                        ...
                        <li class="nav-item">
                                <asp:LinkButton ID="Login" class="nav-link" runat="server" OnClick="Login_Click1">Login</asp:LinkButton>
                            </li>
